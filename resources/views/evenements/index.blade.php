                ...
                @foreach ($evenements as $i=>$item)
                    ...
                    <td>
                        ...
                        <div id="dropdownDots{{$i}}" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                            ...
                            <li>
                                <a href="{{route('evenements.edit', $item->id)}}" class="block px-4 py-2 hover:bg-blue-100 dark:hover:bg-blue-600 dark:hover:text-white">Editer</a>
                            </li>
                            <li>
                                <a data-modal-target="delete-modal" data-modal-toggle="delete-modal" href="" class="block px-4 py-2 hover:bg-red-100 dark:hover:bg-red-600 dark:hover:text-white">Supprimer</a>
                            </li>
                        </div>
                    </td>
                    </tr>
