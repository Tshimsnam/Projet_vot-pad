...
<body class="font-sans text-gray-900 antialiased">
    <div id="loginUser"
    class="bg-cover bg-center min-h-screen flex flex-col justify-center items-center px-4 py-6 sm:pt-0 bg-gray-100 dark:bg-gray-900">
    <div>
        <a href="/">
    ...
    <div
        class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white dark:bg-gray-700 shadow-md overflow-hidden rounded-lg">
        {{ $slot }}
    </div>
</div>
